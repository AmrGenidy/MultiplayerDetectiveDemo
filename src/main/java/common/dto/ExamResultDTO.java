...
public class ExamResultDTO implements Serializable {
    ...
    // This list will now contain strings like: "Q1: How did the killer leave...? Your Answer: 'wrong1'"
    ...
    public ExamResultDTO(int score, int totalQuestions, String feedbackMessage, String finalRank, List<String> reviewableAnswersInfo) {
        ...
        this.reviewableAnswersInfo = reviewableAnswersInfo != null ? new ArrayList<>(reviewableAnswersInfo) : new ArrayList<>();
    }
    ...
    public List<String> getReviewableAnswersInfo() { return new ArrayList<>(reviewableAnswersInfo); }
    public List<String> getIncorrectAnswerDetails() { return Collections.unmodifiableList(reviewableAnswersInfo); } // Renamed getter for clarity
