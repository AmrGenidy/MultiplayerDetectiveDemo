...
/**
 * Data Transfer Object used to notify clients when a Non-Player Character (NPC)
...
public class NpcMovedDTO implements Serializable {
    ...
    /**
     * Gets the name of the NPC that moved.
    ...
    /**
     * Gets the name of the room the NPC moved from.
     * @return The old room name, or null if not applicable.
     */
    ...
    /**
     * Gets the name of the room the NPC moved to.
    ...
    /**
     * Provides a human-readable string representation of the NPC movement,
     * suitable for display in the client's console.
     *
    ...
    public String toString() {
        if (oldRoomName != null && !oldRoomName.equalsIgnoreCase(newRoomName)) {
            ...
            // Case where NPC "moved" but stayed in the same room (shouldn't happen if checked before sending)
