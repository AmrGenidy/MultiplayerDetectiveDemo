...
public class RoomDescriptionDTO implements Serializable {
    ...
    public RoomDescriptionDTO(String name, String description, List<String> objectNames, List<String> occupantNames, Map<String, String> exits) {
        this.name = name;
    ...
    public List<String> getObjectNames() { return new ArrayList<>(objectNames); }
    public List<String> getOccupantNames() { return new ArrayList<>(occupantNames); }
    public Map<String, String> getExits() { return new HashMap<>(exits); }
