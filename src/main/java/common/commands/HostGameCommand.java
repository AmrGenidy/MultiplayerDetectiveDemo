...
import common.dto.HostGameRequestDTO; // Carries caseTitle, isPublic
...
public class HostGameCommand extends BaseCommand {
    ...
    protected void executeCommandLogic(GameActionContext context) {
        ...
        System.out.println("Server received HostGameCommand from player: " + getPlayerId() + " for case: " + payload.getCaseTitle());
    }
