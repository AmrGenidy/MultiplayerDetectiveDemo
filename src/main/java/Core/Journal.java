...
public class Journal<E> implements Serializable {
  ...
  /**
   * Adds an entry to the journal if it doesn't already exist.
   * The definition of "exists" depends on the .equals() method of type E.
   * For JournalEntryDTO, .equals() should probably compare text, contributor, and timestamp.
   *
